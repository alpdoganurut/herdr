...
| Agent | `agent.list`, `agent.get`, `agent.read`, `agent.explain`, `agent.send_keys`, `agent.prompt`, `agent.wait`, `agent.rename`, `agent.focus`, `agent.start`, `agent.suspend`, `agent.activate`, `agent.transcripts`, `agent.view.set`, `agent.view.clear` |
