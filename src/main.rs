...
# Expanded sidebar composition: "spaces" stacks the space panel over the agent panel;
# "tabs" lists one row per tab across every space, in tab order.
# sidebar_layout = "spaces"
