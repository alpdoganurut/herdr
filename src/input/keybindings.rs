...
pub(crate) fn resolve_non_indexed_action(
    ...
    for (bindings, action) in [
        ...
        (&keybinds.restart_agent, KeybindAction::RestartAgent),
        (&keybinds.cycle_tab_color, KeybindAction::CycleTabColor),
        (&keybinds.toggle_tab_remind, KeybindAction::ToggleTabRemind),
